...
async function start(io) {
  ...
  subscriber.on('message', async (channel, message) => {
    ...
    try {
      ...
      // Filter to only allow requested alerts
      const allowedAlerts = ['overspeed', 'geofence', 'ignition_on', 'ignition_off', 'safety_park', 'trip_started', 'excessive_idle', 'sos', 'battery', 'harsh_driving', 'box_open', 'general'];

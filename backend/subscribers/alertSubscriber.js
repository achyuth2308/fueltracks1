...
async function start(io) {
  ...
  subscriber.on('message', async (channel, message) => {
    ...
    try {
      ...
      const allowedAlerts = ['overspeed', 'geofence', 'ignition_on', 'ignition_off', 'stoppage', 'parking', 'safety_park', 'trip_started', 'trip_ended', 'route_deviation', 'excessive_idle', 'sos', 'battery', 'harsh_driving', 'box_open', 'general'];

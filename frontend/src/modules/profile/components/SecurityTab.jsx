        ...
        <div className="bg-white p-6 sm:p-10 rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-slate-200">
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                <p className="text-xs font-bold" style={{ color: '#000000' }}>Account Created</p>
                <p className="text-sm font-extrabold" style={{ color: '#000000' }}>{user?.createdAt ? new Date(user.createdAt).toLocaleString() : 'N/A'}</p>
              </div>
            </div>
            <div className="flex items-start">
              <Monitor className="w-4 h-4 mr-3 mt-0.5" style={{ color: '#000000' }} />
              <div>
                <p className="text-xs font-bold" style={{ color: '#000000' }}>Current Session Role</p>
                <p className="text-sm font-extrabold capitalize" style={{ color: '#000000' }}>{user?.role || 'Unknown'}</p>
              </div>
            </div>

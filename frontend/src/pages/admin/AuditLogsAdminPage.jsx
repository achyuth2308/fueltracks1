    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <button onClick={onClose} style={{ background: '#F1F5F9', border: 'none', borderRadius: '8px', padding: '8px', cursor: 'pointer', color: '#475569' }}>
            <X size={16} />
          </button>
        </div>
      ...
      <div style={{
        ...
        {(auditType !== 'all' || action !== 'all' || search || startDate || endDate) && (
          <button
            ...
            style={{ padding: '9px 14px', borderRadius: '8px', border: '1px solid #E2E8F0', background: '#F8FAFC', color: '#64748B', fontSize: '13px', cursor: 'pointer', fontWeight: 600 }}
          >
            Clear
          </button>
        )}

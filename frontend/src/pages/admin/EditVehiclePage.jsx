      ...
      <div className="p-4 sm:p-10 max-w-[1400px] mx-auto">
        ...
        <SectionCard title="Vehicle Information" icon={Truck}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '24px' }}>
            ...
            <SelectField label="Device Model" value={form.deviceVersion} onChange={e => updateField('deviceVersion', e.target.value)} options={['GT06N', 'FMB920', 'BSTPL-17', 'CONCOX', 'AIS140 V2']} focused={focusedField === 'dver'} onFocus={() => setFocusedField('dver')} onBlur={() => setFocusedField(null)} />

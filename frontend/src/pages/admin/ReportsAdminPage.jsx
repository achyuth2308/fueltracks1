  ...
  return (
    <div style={{ padding: '32px', background: 'linear-gradient(to bottom, #FFF7ED 0%, #FFF7ED 50%, #F8FAFC 50%, #F8FAFC 100%)', minHeight: '100%', display: 'flex', flexDirection: 'column', boxSizing: 'border-box' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
        <div>
          <h1 style={{ fontSize: '24px', fontWeight: 800, color: '#111827', letterSpacing: '-0.02em' }}>Advanced Reports</h1>
          <p style={{ fontSize: '14px', color: '#6B7280', marginTop: '4px' }}>Generate comprehensive fleet analytics and export data.</p>
        </div>
      </div>
      <div style={{
        ...
        <p style={{ fontSize: '14px', color: '#6B7280', maxWidth: '400px', lineHeight: 1.5, marginBottom: '32px' }}>
          The Reporting subsystem is provisioned. Analytics engines are standing by for reporting integration.
        </p>
      </div>
    </div>
  );

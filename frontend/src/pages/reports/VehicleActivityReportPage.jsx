            ...
            <tbody>
              {data.length === 0 ? (
                ...
                <tr key={idx} style={{ borderBottom: '1px solid #F1F5F9' }}>
                  ...
                  <td style={{ padding: '10px 16px', fontSize: '13px', color: '#64748B', fontWeight: 600 }}>{(row.stopped_seconds / 3600).toFixed(2)} h</td>
                  <td style={{ padding: '10px 16px', fontSize: '13px', color: '#475569' }}>{row.distance_travelled || 0}</td>
                  <td style={{ padding: '10px 16px', fontSize: '13px', color: '#475569' }}>{row.trip_count || 0}</td>
                </tr>
              ))}
            </tbody>
          </table>

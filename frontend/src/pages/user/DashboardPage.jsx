...
const DashboardPage = ({ setAppVehicles }) => {
  ...
  const starterStats = countLicenses('Starter');
  const basicStats = countLicenses('Basic');
  const advancedStats = countLicenses('Advanced');
  const premiumStats = countLicenses('Premium');

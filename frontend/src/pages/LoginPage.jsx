...
const LoginPage = () => {
  ...
  return (
    <div className="login-page min-h-screen flex items-center justify-center bg-white font-sans px-6 py-10 text-slate-800 relative overflow-hidden">

      {/* Subtle Background Decorative Elements - Very Faint Soft Glows */}
      {/* Soft circular blur shapes at low opacity */}
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none fill-none" xmlns="http://www.w3.org/2000/svg">
        {/* Soft curving dashed arc sweeping from top-left under logo down toward bottom-right */}
        <path
          ...
          opacity="0.45"
        />
        {/* Secondary subtle straight accent line */}
        <line
          x1="220"
          y1="520"
          x2="720"
        ...
        {/* Subtle scattered hollow oval nodes along the curved line */}
        ...
        {/* Large faint circular ring in bottom-left background */}
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch z-10 min-h-[640px]">

        {/* Left Side - Clean White Aesthetic with Simple Animations */}
        <div className="hidden lg:flex lg:col-span-7 flex-col justify-between py-2 pr-6 relative">
          ...
          <motion.div
            ...
            className="flex flex-col items-start gap-2.5 pt-2 mb-6"
          >
            ...
            <img
              ...
              className="drop-shadow-xs transition-transform hover:scale-[1.01] duration-300 my-1"
            />
          </motion.div>

          {/* Center Content Section */}
          <div className="my-auto py-2">
            {/* LIVE GPS • TELEMATICS • FLEET OPERATIONS Pill Badge - Matching Alternative Colors */}
            <motion.div
            ...
            <motion.h1
              ...
              className="text-3xl lg:text-4xl xl:text-[2.65rem] font-[850] text-[#1b3644] tracking-tight leading-[1.16] mb-5"
            >
            ...
            <motion.p
              ...
              className="text-slate-600 text-base lg:text-lg leading-relaxed max-w-lg mb-8 font-normal"
            >
            ...
            <div className="grid grid-cols-3 gap-3.5 max-w-md">
              <motion.div
                ...
                className="bg-white rounded-xl p-3.5 sm:p-4 shadow-xs hover:shadow-md border border-slate-100 transition-all duration-300 hover:-translate-y-0.5"
              >
                <div className="w-7 h-7 rounded-lg bg-sky-50 text-sky-600 flex items-center justify-center mb-2.5 border border-sky-100">
                  <Truck className="w-3.5 h-3.5 stroke-[2.2]" />
                </div>
                <div className="text-xl sm:text-2xl font-extrabold text-[#1b3644] tracking-tight mb-0.5 leading-none">
                  247
                </div>
              ...
              <motion.div
                ...
                className="bg-white rounded-xl p-3.5 sm:p-4 shadow-xs hover:shadow-md border border-slate-100 transition-all duration-300 hover:-translate-y-0.5"
              >
                <div className="w-7 h-7 rounded-lg bg-violet-50 text-violet-600 flex items-center justify-center mb-2.5 border border-violet-100">
                  <Gauge className="w-3.5 h-3.5 stroke-[2.2]" />
                </div>
                <div className="text-xl sm:text-2xl font-extrabold text-[#1b3644] tracking-tight mb-0.5 leading-none whitespace-nowrap">
          ...
          >
            <div className="w-[72px] py-3 bg-white rounded-xl shadow-xs hover:shadow-md border border-slate-100 flex flex-col items-center justify-center gap-1.5 hover:-translate-y-0.5 transition-all duration-300 cursor-pointer">
              ...
              <span className="text-[10px] font-bold text-slate-700">Freight</span>
            </div>
            ...
            <div className="w-[72px] py-3 bg-white rounded-xl shadow-xs hover:shadow-md border border-slate-100 flex flex-col items-center justify-center gap-1.5 hover:-translate-y-0.5 transition-all duration-300 cursor-pointer">
              ...
              <span className="text-[10px] font-bold text-slate-700">Delivery</span>
            </div>
            ...
            <div className="w-[72px] py-3 bg-white rounded-xl shadow-xs hover:shadow-md border border-slate-100 flex flex-col items-center justify-center gap-1.5 hover:-translate-y-0.5 transition-all duration-300 cursor-pointer">
              ...
              <span className="text-[10px] font-bold text-slate-700">Fleet</span>
            </div>
          </motion.div>
        ...
        <div className="w-full lg:col-span-5 max-w-md mx-auto my-auto">
          <motion.div
          ...
          >
            {/* Soft Outer Ambient Glow - Pink, Blue & White Theme */}
            ...
            {/* Inner Card Content */}
            <div className="bg-white rounded-[13.5px] p-6 sm:p-8 relative z-10 shadow-[0_20px_50px_rgba(249,115,22,0.14)] transition-shadow duration-300 group-hover:shadow-[0_25px_60px_rgba(249,115,22,0.22)]">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#f97316]/50 focus:border-[#f97316] focus:shadow-[0_0_12px_rgba(249,115,22,0.15)] transition-all duration-200 ease-out placeholder:text-slate-800 text-slate-900"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-10 py-3 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#f97316]/50 focus:border-[#f97316] focus:shadow-[0_0_12px_rgba(249,115,22,0.15)] transition-all duration-200 ease-out placeholder:text-slate-800 text-slate-900"
                    />
                    <button
                      type="button"
                ...
                <motion.button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3.5 text-white rounded-xl font-bold text-sm transition-shadow disabled:opacity-70 disabled:cursor-not-allowed hover:shadow-lg cursor-pointer"
                  style={{
